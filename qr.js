...
router.get('/', async (req, res) => {
    ...
    async function initiateSession() {
        ...
        if (!fs.existsSync(dirs)) fs.mkdirSync(dirs, {
            recursive: true
        });
        ...
        try {
            ...
            const socketConfig = {
                ...
                // Using Browsers enum for better compatibility
                auth: {
                    creds: state.creds,
                ...
                // Disable to reduce connection issues
            ...
            const handleConnectionUpdate = async (update) => {
                ...
                if (connection === 'open') {
                    ...
                    try {
                        ...
                        ? jidNormalizedUser(sock.authState.creds.me.id): null;
